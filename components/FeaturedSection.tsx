    ...
    <section className="py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <motion.div
          ...
          viewport={{ once: true }} // write this for just one time animate, not every time we scroll
          transition={{ duration: 0.6 }}
        >
          <h2 className="text-3xl md:text-4xl font-serif mb-4 font-bold text-foreground">
            Featured Insights
          </h2>
